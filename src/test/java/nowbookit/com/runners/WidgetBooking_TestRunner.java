...
@CucumberOptions(
        ...
        plugin = {"nowbookit.com.hooks.CucumberListener",
                "pretty",
                "html:target/cucumber-reports/WidgetBooking_TestRunner.html",
                "json:target/cucumber-reports/WidgetBooking_TestRunner.json",
                "com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
        , monochrome = true,
        tags = "@Regression or @Smoke"
)

public class WidgetBooking_TestRunner extends AbstractTestNGCucumberTests {
    @Override
